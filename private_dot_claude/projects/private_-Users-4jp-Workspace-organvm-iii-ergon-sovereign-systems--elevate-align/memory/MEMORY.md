# Memory Index — sovereign-systems--elevate-align
...
- [feedback_persistence-rule.md](feedback_persistence-rule.md) — Local and remote must be 1:1 simultaneous
- [feedback_gemini-confabulation.md](feedback_gemini-confabulation.md) — Always verify agent output at file level, never trust self-reported aggregates
...
- [reference_auto-sync-defect.md](reference_auto-sync-defect.md) — ORGANVM auto-sync tooling doesn't read seed.yaml edges
