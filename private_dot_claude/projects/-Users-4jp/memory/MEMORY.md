...
## Active Artifacts
- [Skills shipped 2026-05-05 — premortem + expansive-inquiry](project_artifact_skills_premortem_expansive_2026_05_05.md) — PR #18 open on a-i--skills (3/4 CI green); two skills: `skills/project-management/premortem/` (Klein-method) + `skills/knowledge/expansive-inquiry/` (six-lens chorus); two atomic commits, schema-conformant frontmatter
...
## Session Logs
- [2026-05-05 skills — premortem + expansive-inquiry](project_session_2026-05-05_skills_premortem_expansive.md) — Two new skills shipped via PR #18 on a-i--skills; user-pasted artifacts (Klein-method premortem text + React V4 expansive-inquiry prototype with critique notes) distilled into schema-conformant SKILL.md files; 5 frontmatter violations caught + fixed; PR-route taken per morning's correction; 3/4 CI green at session-end
