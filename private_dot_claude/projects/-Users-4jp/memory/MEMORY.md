...
## Projects
- [ORGANVM system state](project_organvm_pactvm.md) — 10 organs, 145 repos, omega 9/20, launched 2026-02-11
...
- [Session archival system](project_session_archive_system.md) — Per-project conversation preservation, LaunchAgent automation, IRF-DOM-029 resolved (2026-04-15)
